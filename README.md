...
- 宠物页 Three.js 精细卡通 3D 建模（4种宠物，呼吸/眨眼/尾巴摇摆/翅膀扇动动画）
...
| 宠物 | 模型类型 | 特征 | 价格 |
|------|----------|------|------|
| 🦊 星灵狐 | fox | 橙色身体、三角尖耳、蓬松大尾巴、白色腹部 | 150 |
| 🐱 星云猫 | cat | 灰蓝色身体、尖耳、绿色猫眼、粉色鼻子、长尾 | 150 |
| 🐉 星辉龙 | dragon | 绿色身体、龙角、翅膀、橙色背刺、箭头尾尖 | 200 |
| 🐦 星辰鸟 | bird | 黄色圆润身体、橙色鸟喙、蓝绿翅膀、头顶羽冠 | 150 |

> 所有宠物外表与名称吻合，非简单几何体堆砌。每种宠物有独立动画（呼吸/眨眼/尾巴摇摆/翅膀扇动），心情和饱腹度影响动作幅度。
...
│   │       └── Pet3D.tsx             # Three.js 3D 宠物精细建模（4种宠物）
│   ├── features/
│   │   ├── auth/                     # 认证（登录/注册）
│   │   ├── class/                    # 班级（列表/聊天）
